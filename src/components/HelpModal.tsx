  ...
  return <Modal opened={opened} onClose={onClose} title="How to Play" size="xl" centered transitionProps={{ duration: 0 }}>
    <Tabs defaultValue="play">
      ...
      <Tabs.Panel value="flames" pt="md">
        <Text size="sm" mb="sm">Every third clear adds a +5 Flame Bonus and opens the special Flame Reward where new Flames are acquired. Owned Embers may be Stoked with any whole Gold amount there or through their physical die at every normal shop. At exactly 100, a Flame becomes a global Bonfire, detaches from its die, and triggers once globally.</Text>
      ...
      <Tabs.Panel value="shop" pt="md"><Text size="sm">Hand Training still costs {CONFIG.handTrainingCost} Gold. Enhancement purchases require the exposed face. With no offer selected, select a die to open Manage Die, inspect all six faces, scrap enhancements, and Stoke its owned Flame. Shops never offer new Flames. Trying to add a fourth enhancement type opens that modal while preserving the pending offer. Paid dice rerolls cost 2, 4, 8, 16… and reset each shop.</Text><Text size="sm" mt="sm">Flame Reward dice carry into the following shop. The carried roll is not a paid reroll and the first paid reroll still costs 2.</Text></Tabs.Panel>
    </Tabs>
  </Modal>;
}
