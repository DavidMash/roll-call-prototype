  ...
  return <Modal opened={opened} onClose={onClose} title="How to Play" size="xl" centered transitionProps={{ duration: 0 }}>
    <Tabs defaultValue="play">
      ...
      <Tabs.Panel value="flames" pt="md">
        <Text size="sm" mb="sm">Every third clear adds a +5 Flame Bonus and opens one unified Flame screen. New Flames are 0-Gold Embers with no meaningful effect. Select an Ember die to Stoke it with any whole Gold amount. At exactly 100, a Flame becomes a global Bonfire, detaches from its die, and triggers once globally.</Text>
