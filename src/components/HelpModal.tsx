  ...
  return <Modal opened={opened} onClose={onClose} title="How to Play" size="xl" centered transitionProps={{ duration: 0 }}>
    <Tabs defaultValue="play">
      ...
      <Tabs.Panel value="flames" pt="md">
        <Text size="sm" mb="sm">Every third clear adds a +10 Boss Reward, shows the Round Summary, and opens the special Flame Selection only to choose and assign one new Flame, or skip. Its three offers cannot be rerolled and no Gold is spent there.</Text>
