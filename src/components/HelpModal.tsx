  ...
  return <Modal opened={opened} onClose={onClose} title="How to Play" size="xl" centered transitionProps={{ duration: 0 }}>
    <Tabs defaultValue="play">
      ...
      <Tabs.Panel value="bosses" pt="md">
        ...
        <div className="help-item"><Text fw={800}>THE INFECTED</Text><Text size="sm">Each die starts with an infected face. Exposed infection spreads to clean faces on other rolling dice and disables only that face's enhancements.</Text></div>
      </Tabs.Panel>
