  ...
  return <Modal opened={opened} onClose={onClose} title="How to Play" size="xl" centered transitionProps={{ duration: 0 }}>
    <Tabs defaultValue="play">
      ...
      <Tabs.Panel value="play" pt="md">
        ...
        <Text size="sm" mt="sm">A run starts with 3 lives. With no playable hands and no rerolls, the attempt Busts: one life is lost and the same round restarts with distinct deterministic rolls. Failed-attempt Gold and permanent growth are rolled back. A Bust at 1 life leaves 0 and ends the run.</Text>
        <Text size="sm" mt="sm">Every clear pays 5 base Gold, 1 per unused reroll, and interest equal to floor(held Gold / 5), capped at 5. Scoring Gold is included before interest. Every third clear then adds a +5 Flame Bonus.</Text>
      </Tabs.Panel>
      ...
      <Tabs.Panel value="flames" pt="md">
        <Text size="sm" mb="sm">Every third clear adds a +5 Flame Bonus and opens the special Flame Reward only to choose and assign one new Flame, or skip. Its three seeded offers cannot be rerolled and no Gold is spent there.</Text>
